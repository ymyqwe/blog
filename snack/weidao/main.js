...
window.onload = function () {
	...
	var content = {
		titleBg : [{img: "weidao/0_002.gif"}, {img: "http://mmbiz.qpic.cn/mmbiz/2ryTJ7znBT4DeVahSsiaPRdibzxnSWhWEBoXWsBxFLzdWqicvqAC3szuMibmYwgtk0O5kYhnBV0FKaU0zyGMNicG4tA/0"}],
		select : {q: "选择性别，开始测试喽~", male: "weidao/sushi.png", next: 1},
		question : [{img1: "weidao/sushi.png", img2: "http://mmbiz.qpic.cn/mmbiz/2ryTJ7znBT4DeVahSsiaPRdibzxnSWhWEBCiaEJaX8kSNRbecaErgX09mAVV3X4cwUzFZQ5dGwIibE6TBnLSMzQPmQ/0", q: "1. 你会把自己比喻成哪种花香？", a1: {con: "浓郁的花香", next: 2}, a2: {con: "清淡的花香", next: 3}},
	...
	function refreshAnswer(idx) {
		...
		a.href = "http://game.vbaitong.com/quiz.htm";
